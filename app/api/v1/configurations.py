...
async def parameter_catalog(session: Session, user: CurrentUser):
    return success({
        ...
        "parameters": [
            ...
            {"name": "append_duplicate_policy", "type": "enum", "default": None, "supported": True,
             "allowed": ["SKIP_IDENTICAL", "REJECT_IDENTICAL"],
             "scope": "APPEND without business/primary keys; null means SKIP_IDENTICAL"},
            {"name": "columns", "type": "array", "default": [], "supported": True},
            {"name": "data_quality_rules", "type": "array", "default": [], "supported": True},
            {"name": "semantic.metrics.null_handling", "type": "enum", "default": "PRESERVE", "supported": True,
             "values": ["PRESERVE", "ZERO_RESULT"], "scope": "numeric aggregate output; ETL configuration review required"},
            {"name": "semantic.metrics.description", "type": "string", "default": "", "supported": True,
             "scope": "business definition; max 1000 characters; ETL configuration review required"},
            {"name": "semantic.metrics.unit", "type": "string", "default": None, "supported": True,
             "scope": "display metadata; max 40 characters; ETL configuration review required"},
            {"name": "semantic.metrics.synonyms", "type": "string[]", "default": [], "supported": True,
             "scope": "max 20 unique aliases of 100 characters; ETL configuration review required"},
            {"name": "semantic.metrics.default_period", "type": "object", "default": None, "supported": True,
             "scope": "temporal semantic dimension plus 1..3660 UTC days; applied when that dimension is unfiltered"},
            {"name": "semantic.metrics.filters", "type": "object[]", "default": [], "supported": True,
             "scope": "up to 10 typed allowlisted predicates applied inside the aggregate; ETL review required"},
            ...
            {"name": "transformation_codes", "type": "enum[]", "default": [], "supported": True, "allowed": ["trim", "normalize_whitespace", "parse_date_id", "parse_decimal_id", "uppercase", "lowercase", "null_if_empty", "prefix", "suffix", "replace"]},
            {"name": "transform_parameters", "type": "object[]", "default": [], "supported": True, "scope": "columns.transform_parameters; prefix/suffix/replace on text/varchar; no dynamic expressions"},
        ...
        "operations": [
            ...
            {"code": "prefix", "parameters": {"value": "string"}, "on_error": "REJECT_ROW", "supported": True, "scope": "text/varchar columns"},
            {"code": "suffix", "parameters": {"value": "string"}, "on_error": "REJECT_ROW", "supported": True, "scope": "text/varchar columns"},
            {"code": "replace", "parameters": {"value": "string", "replacement": "string"}, "on_error": "REJECT_ROW", "supported": True, "scope": "text/varchar columns"},
        ],
