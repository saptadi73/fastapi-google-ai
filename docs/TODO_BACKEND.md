...
- [~] Implementasikan versi/master bermasa berlaku: versi eksplisit immutable, key entitas + valid_from, validasi overlap preview/apply dan skip UNCHANGED tersedia. Penutupan periode terbuka tersedia melalui preview opt-in dan approval; koreksi bebas, FK as-of, dan hardening PostgreSQL masih terbuka. Lihat [panduan](EFFECTIVE_DATING_BE12.md).
